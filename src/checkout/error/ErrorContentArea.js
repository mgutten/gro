...
class ErrorContentArea extends Component {

  sadFace() {
    return <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    	 width="60px" height="60px" viewBox="0 0 438.533 438.533" style={{marginTop: '40px', enableBackground:'new 0 0 438.533 438.533'}}
    	 xmlSpace="preserve">
    <g>
    	<g>
  ...
  render() {
    return (
      ...
      <h4 style={{marginTop: '20px', fontWeight: '300'}}>Your order wasn't processed.  Unfortunately, we're temporarily out of stock.  We're growing fast, so we'll contact you when our next batch is ready.<br/>.<br/>Sorry for the inconvenience!</h4>
      </section>
    );
  }
}

export default ErrorContentArea;
